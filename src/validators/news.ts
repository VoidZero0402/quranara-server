...
export const CreateNewsSchema = z.object({
    ...
    description: z.string({ required_error: "description is required" }).min(1, { message: "title should not be empty" }).max(255, { message: "title should be has less than 255 character" }).trim(),
    link: z
        .object({
